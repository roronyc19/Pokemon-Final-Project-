...
for x in range (20):
    ...
    Player_list.append(Computer_Player(random.randint(4,width-5), random.randint(4,length-5), \
                                       random.choice(field_arr_2), color[0], color[1], random.choice(["up", "down", "left", "right"]), [new_arbok()]))
...
pygame.mixer.music.load('Route Music.mp3') # Loads battle music 
